...
Principal components analysis is a standart approach to study conformational changes in biological molecules, in particular when the free energy lanscape has only 1 global minima. PCAlipids is a python based software that performs complete quantitative analysis of conformations and dynamics of lipids or other small molecules. All the information about the approach could be found in the following papers:
